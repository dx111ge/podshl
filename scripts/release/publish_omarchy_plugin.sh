...
#
#   scripts/release/publish_omarchy_plugin.sh /path/to/omarchy-podshl-checkout
#
...
# plugin from `packaging/omarchy-plugin/`, the licence, and the AUR package's PKGBUILD in
...
DEST="${1:?usage: scripts/release/publish_omarchy_plugin.sh <path to the plugin checkout>}"
cd "$(dirname "$0")/../.."
